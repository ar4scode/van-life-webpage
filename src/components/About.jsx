...
const About = () => {
  return (
    <div className='font-sans'>
      ...
      <p className='mt-5 px-3 md:w-3/4'>Our mission is to enliven your road trip with the perfect travel van rental. Our vans are recertified nefore each trip to ensure your travel plans can go off without a hitch.</p>
